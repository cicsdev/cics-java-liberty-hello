...
## Building
The sample can be built with CICS Explorer, Gradle or Apache Maven. It is recommened to use the supplied Gradle or Maven wrapper to get a consistent and updated version of build tooling.
